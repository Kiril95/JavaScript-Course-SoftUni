...
import { editItem } from '../src/actions/edit.js';

export let editTemplate = (item, errors) => {
    return html`
    ...
    <form data-id="${item._id}" id="edit-form" @submit=${editItem}>
        <div class="row space-top">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input class=${'form-control' + (errors.img ? ' is-invalid'  : ' is-valid' )} type="text" name="img" value=${item.img}>
                </div>
                <div class="form-group">
